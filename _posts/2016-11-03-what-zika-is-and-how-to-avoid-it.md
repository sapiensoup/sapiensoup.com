...
<figure style="width: 240px" class="wp-caption aligncenter"><img class="size-full" src="/images/zika/Zika-virus-particle.png" alt="Zika virus particle" width="240" height="240" srcset="/images/zika/Zika-virus-particle.png 240w, /images/zika/Zika-virus-particle-150x150.png 150w" sizes="(max-width: 240px) 85vw, 240px"><figcaption class="wp-caption-text"><center>Zika virus particle (By Manuel Almagro Rivas, <a href="http://creativecommons.org/licenses/by-sa/4.0">CC BY-SA 4.0</a>, via Wikimedia Commons)</center></figcaption></figure>
